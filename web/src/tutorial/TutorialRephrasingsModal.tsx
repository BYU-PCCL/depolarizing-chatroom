...
function TutorialRephrasingsModal({
  ...
  return (
    ...
    >
      <div className="flex">
        <div className="relative ml-2 mr-3 mt-3 -mb-5 p-0 w-full">
          <div
            ref={chatMessagesElement}
            className="flex-1 basis-0 overflow-scroll px-3 pt-3 -mx-3 -mt-4 h-full pb-9 -mb-6 w-full border border-green-600 rounded-lg [overflow-anchor:none]"
          >
              ...
              {rephrasings.map((rephrasing, i) => (
                <ComposeMessage
                  ...
                  colors={["400", "200", "600"].map(
                    (value) =>
                      (highlightingRephrasings ? "green" : "blue") + "-" + value
                  )}
                />
              ))}
            </div>
